...
const HowToHelp = () => {
  ...
  // Mapeamos el progreso del scroll a un movimiento vertical más lento para el fondo
  const y = useTransform(scrollYProgress, [0, 1], ["-20%", "20%"]);
  return (
    <section ref={targetRef} id="como-ayudar" className="relative py-20 bg-white h-[80vh] overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 h-full flex flex-col justify-center">
        <motion.h2
            ...
            className="text-4xl font-bold text-white mb-4 text-center font-title"
        >
            CÓMO AYUDAR
        </motion.h2>
